...
def parse_opt(known=False):
    ...
    # 网络选择
    # YOLOv5s 14MB 2.0ms 37.2mAP
    # YOLOv5m 41MB 2.7ms 44.5mAP
    # YOLOv5l 90MB 3.8ms 48.2mAP
    # YOLOv5x 168MB 6.1ms 50.4mAP
    parser.add_argument('--weights', type=str, default='yolov5m.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    # 数据集索引配置文件
    parser.add_argument('--data', type=str, default='data/BleachVsNaruto.yaml', help='datasets.yaml path')
    ...
    parser.add_argument('--upload_dataset', action='store_true', help='Upload datasets as W&B artifact table')
    parser.add_argument('--bbox_interval', type=int, default=-1, help='Set bounding-box image logging interval for W&B')
    parser.add_argument('--save_period', type=int, default=-1, help='Log model after every "save_period" epoch')
    parser.add_argument('--artifact_alias', type=str, default="latest", help='version of datasets artifact to be used')
