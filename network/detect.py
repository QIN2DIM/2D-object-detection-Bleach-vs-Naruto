"""Run inference with a YOLOv5 model on images, video, directories, streams
...
def run(weights='yolov5s.pt',  # model.pt path(s)
        ...
        nosave=False,  # do not save images/video
...
def parse_opt():
    ...
    parser.add_argument('--nosave', action='store_true', help='do not save images/video')
